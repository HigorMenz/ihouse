function eventListeners(){document.querySelector(".mobile-menu").addEventListener("click",responsiveNavigation)}function responsiveNavigation(){document.querySelector(".navbar").classList.toggle("show")}
